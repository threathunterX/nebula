...
class UserDatastore(object):
    ...
    def __init__(self, user_model, role_model, log_model):
    ...
    def create_login_log(self, **kwargs):
        log = self.log_model(**kwargs)
        return self.put(log)
...
class SQLAlchemyUserDatastore(SQLAlchemyDatastore, UserDatastore):
    ...
    """
    def __init__(self, db, user_model, role_model, log_model):
        SQLAlchemyDatastore.__init__(self, db)
        UserDatastore.__init__(self, user_model, role_model, log_model)
