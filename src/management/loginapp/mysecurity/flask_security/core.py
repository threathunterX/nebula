...
from myflask_login import AnonymousUserMixin, UserMixin as BaseUserMixin, \
...
_default_config = {
    ...
    'EMAIL_HTML': True,
    'CONFIRM_EMAIL_URL_PREFIX' : 'http://127.0.0.1/confirm',
    'RESET_EMAIL_URL_PREFIX' : 'http://127.0.0.1/reset',
