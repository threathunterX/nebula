...
from flask import (abort, current_app, Response, request, jsonify,
                   url_for, redirect, _request_ctx_stack)
from myflask_login import current_user, login_required  # pragma: no flakes
...
def anonymous_user_required(f):
    ...
    def wrapper(*args, **kwargs):
        if current_user.is_authenticated:
            if request.json:
                retdict = {"meta":{"code":201},"response":{}}
