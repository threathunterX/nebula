...
from myflask_login import login_user as _login_user, logout_user as _logout_user
...
def create_login_log(user, status):
    ...
    _datastore.create_login_log(email=user.email, loginstatus=status, loginip=realIp, logintime=logintime)
